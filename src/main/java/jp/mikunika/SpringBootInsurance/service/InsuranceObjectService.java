...
public interface InsuranceObjectService extends BaseService<InsuranceObject> {
    ...
    List<InsuranceOption> getObjectOptions(Long objectId);
    ...
    InsuranceObject addOptionToObject(Long objectId, InsuranceOption option);
    InsuranceObject addPolicyToObject(Long objectId, InsurancePolicy policy);
    InsuranceObject addTypeToObject(Long objectId, InsuranceObjectType objectType);
